...
const STEPS = [
  {
    number: "01",
    title: "Visita e Diagnostico",
    description: "Avaliamos o espaco gratuitamente e ouvimos as suas necessidades.",
    icon: (
  ...
  {
    number: "02",
    title: "Orcamento Fixo",
    description: "Preco fechado, sem surpresas. Sabe exactamente quanto vai investir.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    number: "03",
    title: "Obra com Gestao Dedicada",
    description: "Um gestor unico, actualizacoes diarias por WhatsApp. Zero stress.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Limpeza final incluida, garantia de 5 anos em todas as intervencoes.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  return (
    <SectionWrapper id="metodo" className="bg-diagonals py-28">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          eyebrow="O Metodo"
          title="Do contacto a entrega da chave"
        ...
        <div className="mt-14 text-center">
          ...
          >
            Pronto para comecar? <span>&rarr;</span> Pedir orcamento
          </a>
        </div>
      </div>
    </SectionWrapper>
