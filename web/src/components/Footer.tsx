      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="glass-panel rounded-2xl p-5 sm:p-8 md:p-12">
          ...
          <div className="mb-8 text-center sm:mb-12">
            <p
              className="mb-3 text-[10px] font-medium tracking-[0.3em] uppercase sm:mb-4 sm:text-xs"
              style={{ color: "#D6D3D1" }}
            >
              Trabalhamos com
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-10">
              {SUPPLIERS.map((s) => (
                <span
                  key={s}
                  className="text-sm font-semibold transition-colors hover:text-[#E67E22] sm:text-lg"
                  style={{ color: "#D6D3D1" }}
                >
                  {s}
                </span>
          ...
          <div className="mb-8 flex flex-col items-center gap-4 sm:mb-12 sm:flex-row sm:gap-6">
            ...
            <div className="text-center sm:text-left">
              <p className="text-base font-bold tracking-wide sm:text-lg" style={{ color: "#FFFFFF" }}>
                CRONOGRAMA
              </p>
              <p
                className="text-[10px] font-light tracking-[0.25em] sm:text-xs"
                style={{ color: "#E67E22" }}
              >
                Home Service
              </p>
          ...
          <div className="grid gap-8 sm:grid-cols-3 sm:gap-12">
              ...
              <ul className="space-y-2.5">
                {LINKS.map((link) => (
                  <li key={link.href}>
                    <a
                      href={link.href}
                      className="text-sm transition-colors hover:text-[#E67E22]"
                      style={{ color: "#D6D3D1" }}
                    >
                      {link.label}
                    </a>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm" style={{ color: "#D6D3D1" }}>
                <li>
                  <a href="tel:+351931428476" className="transition-colors hover:text-[#E67E22]">
                    +351 931 428 476
                  </a>
                </li>
                <li>
                  <a href="tel:+351935602904" className="transition-colors hover:text-[#E67E22]">
                    +351 935 602 904
                  </a>
                </li>
                <li>
                  <a href="mailto:grupocronograma@hotmail.com" className="transition-colors hover:text-[#E67E22]">
                ...
                <li>
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 transition-colors hover:text-[#E67E22]"
                  >
                ...
                <li style={{ color: "rgba(214,211,209,0.60)" }}>Lisboa, Portugal</li>
              </ul>
            </div>
          ...
          <div
            ...
            style={{ borderColor: "rgba(230,126,34,0.10)", color: "#D6D3D1" }}
          >
